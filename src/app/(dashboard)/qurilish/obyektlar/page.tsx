...
export default function QurilishObyektlarPage() {
  ...
  const load = async () => {
    setLoading(true);
    try {
      const params: Record<string,string> = { type:"QURILISH" };
  ...
  const handleSave = async () => {
    ...
    try {
      if (modal === "create") {
        const created = await createProject({ ...INIT, ...form, type:"QURILISH" } as ProjectCreateDto);
    ...
    <div className="-m-6 flex flex-col" style={{ minHeight:"calc(100vh - 60px)", background:"#faf7f0" }}>
      ...
      <div className="flex-shrink-0 px-6 pt-5 pb-4 flex items-start justify-between"
        ...
        <div>
          ...
          <h1 className="text-lg font-bold" style={{ color:N }}>Qurilish Obyektlari</h1>
          <p className="text-[11px] mt-0.5" style={{ color:T2 }}>Barcha qurilish loyihalari</p>
        </div>
      ...
      <div className="px-6 py-3 flex items-center gap-2 flex-shrink-0">
        ...
        <span className="ml-auto text-xs font-medium" style={{ color:T2 }}>Jami: {items.length}</span>
      </div>
          ...
          <div className="w-full max-w-[580px] rounded-2xl overflow-hidden"
            ...
            <div className="px-6 py-4 flex items-center justify-between" style={{ borderBottom:`1px solid ${CDD}` }}>
              <h2 className="text-base font-bold" style={{ color:N }}>
                {modal==="create" ? "Yangi qurilish obyekti" : "Obyektni tahrirlash"}
              </h2>
          ...
          <div className="w-full max-w-[360px] rounded-2xl overflow-hidden"
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-center mb-6" style={{ color:T2 }}>
                Bu obyekt butunlay o&apos;chib ketadi. Amalni qaytarib bo&apos;lmaydi.
              </p>
