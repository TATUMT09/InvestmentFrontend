...
export default function TashkilotMomoDetailPage() {
  ...
  return (
    <div className="max-w-2xl space-y-4">
      ...
      <div className="p-5 rounded-2xl" style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.08)" }}>
        ...
        {base.deadline && (
          <div className="mt-3 flex items-center gap-2 text-sm"
            ...
            <span>⏰</span> Muddat: <span className="font-bold">{base.deadline}</span>
          </div>
        )}
      </div>
      ...
      {/* Xodim assignment */}
      <div className="p-5 rounded-2xl" style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.08)" }}>
        <p className="text-sm font-bold mb-3" style={{ color:"rgba(150,180,230,0.75)" }}>👷 Mas'ul xodim</p>
        <div className="flex gap-3">
          ...
          {xodim && (
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl flex-shrink-0"
              ...
              <span className="text-sm font-semibold">{xodim}</span>
            </div>
          )}
        </div>
      </div>
      ...
      {nextBtn ? (
        <div className="p-5 rounded-2xl space-y-3"
          ...
          <textarea value={izohInput} onChange={e=>setIzohInput(e.target.value)}
            placeholder="Nima ish qilindi? (izoh qoldiring)..."
            rows={3}
        ...
        <div className="p-4 rounded-2xl text-center"
          ...
          <p className="text-sm font-bold" style={{ color:"#34d399" }}>✓ Momo muvaffaqiyatli yakunlangan</p>
        </div>
      )}
